...
def process_song_file(cur, filepath):
    """
    This function reads song data and executes the insert query 
    to populate the relational databse.
    input: cursor, filepath
    returns: None
    """
    # open song file
...
def process_log_file(cur, filepath):
    ...
    databaseThis function reads log data.
    input: cursor, filepath
    returns: None
    """
    # open log file
...
def process_data(cur, conn, filepath, func):
    ...
    input: cursor, connection, filepath and ETL function
    return: None
    """
